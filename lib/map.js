...
/*    var AddLayerButton = L.Control.extend({
    ...
    var ZoomInButton = L.Control.extend({
      ...
      onAdd: function () {
        var button = L.DomUtil.create("button", "zoom-in")
        button.textContent = "\uF2C7"
    ...
    var ZoomOutButton = L.Control.extend({
      ...
      onAdd: function () {
        var button = L.DomUtil.create("button", "zoom-out")
        button.textContent = "\uF2F4"
